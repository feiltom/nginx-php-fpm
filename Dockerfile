...
RUN apt-get update;apt-get -y install git zip zlib1g-dev libicu-dev libfreetype6-dev libjpeg62-turbo-dev libpng-dev g++ ca-certificates wget cron;apt-get clean
